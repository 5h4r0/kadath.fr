        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6 font-light text-white text-lg leading-relaxed lg:text-xl">
            <h2 className="text-2xl">
              <span className="mark-gray">Problème client</span>
            </h2>
            <p>Aujourd'hui, beaucoup de sites construits avec WordPress :</p>
            <ul className="flex flex-col gap-2 pl-2">
              <li>
                <span className="text-tt-accent">•</span> manquent de clarté
              </li>
              <li>
                <span className="text-tt-accent">•</span> sont peu différenciants
              </li>
              <li>
                <span className="text-tt-accent">•</span> ne génèrent pas de résultats
              </li>
            </ul>
            <p>
              <span className="mark-gray">Résultat</span>
            </p>
            <p>
              Un site qui existe…{' '}
              <span className="mark-gray">mais qui ne sert pas votre activité.</span>
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6 font-light text-white text-lg leading-relaxed lg:text-xl">
            <h2 className="font-bold text-2xl">
              <span className="mark-gray">Solution</span>
            </h2>
            <p>Nous concevons des sites esthétiques et performants. C'est la base, d'après nous.</p>
            <p className="font-bold text-2xl">
              <span className="mark-teal">Notre approche</span>
            </p>
            <ul className="flex flex-col gap-2 pl-2">
              <li>
                <span className="text-tt-accent">•</span>{' '}
                <span className="mark-teal">un design sur mesure</span>
              </li>
              <li>
                <span className="text-tt-accent">•</span>{' '}
                <span className="mark-teal">une structure claire</span>
              </li>
              <li>
                <span className="text-tt-accent">•</span>{' '}
                <span className="mark-teal">un développement solide</span>
              </li>
              <li>
                <span className="text-tt-accent">•</span>{' '}
                <span className="mark-teal">un site pensé pour durer</span>
              </li>
            </ul>
          </div>
        </div>
